...
pub unsafe fn multiply_array(ptr: *const i32, len: usize) -> i32 {
    let mut product = 1;
    for i in 0..len { // Começar a multiplicação do índice 0
...
fn main() {
    println!("a multiplicação é de 24");
}

//o erro era provocado pois nao estava considersando o n0 para o calculo